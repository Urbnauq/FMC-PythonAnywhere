...
class WorkOrderForm(forms.ModelForm):
    ...
    class Meta:
        model = Work
        fields = ('private', 'company', 'address', 'apartment', 'city', 'state', 'zip_code', 'appliance', 'phone',)
        label_suffix = '-'
        labels = {
...
class WorkOrderFormUpdate(forms.ModelForm):
    ...
    class Meta:
        model = Work
        fields = ('status', 'private', 'company', 'address', 'apartment', 'city', 'state', 'zip_code', 'appliance', 'phone',)
        label_suffix = '-'
        labels = {
            'company': 'Management Company or Name',
            'private': 'Private Job'
