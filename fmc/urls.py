...
urlpatterns = [
    ...
    path('work_orders_pending/', views.WorkOrdersPending.as_view(), name='work-orders-pending'),
    path('work_orders_2c2r/', views.WorkOrders2C2R.as_view(), name='work-orders-2c2r'),
    path('work_orders_completed/', views.WorkOrdersCompleted.as_view(), name='work-orders-completed'),
